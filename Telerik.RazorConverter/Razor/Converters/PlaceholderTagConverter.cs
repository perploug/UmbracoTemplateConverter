...
{
    public class PlaceholderTagConverter : INodeConverter<IRazorNode>
    {
        ...
        public PlaceholderTagConverter(IRazorNodeConverterProvider converterProvider
                                  )
        {
        ...
        public bool CanConvertNode(IWebFormsNode node)
        {
            ...
            return serverControlNode != null && serverControlNode.TagName.ToLowerInvariant() == "asp:placeholder";
        }
    }
}
